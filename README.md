...
```
You dont need to install any modules opening setup.exe will install them for you. Then you need to open setup.exe as administrator which will
open the gui.
```
### 4. Create A Webhook:
